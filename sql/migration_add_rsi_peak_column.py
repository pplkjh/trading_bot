"""
rsi_peak 컬럼 추가 migration (B전략 RSI Top Failure Swing 매도용)
보유 중 RSI14 최고값을 추적하여 천장 이탈 시 매도 신호 생성.
컬럼이 이미 있으면 스킵, 없으면 추가.

실행: python sql/migration_add_rsi_peak_column.py
"""
import sys
import pathlib
...
COL = ('rsi_peak', 'DECIMAL(6,2) DEFAULT 0 COMMENT "보유 중 RSI14 최고값 (Top Failure Swing 매도용)"')
